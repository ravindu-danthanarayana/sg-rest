  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-3 heading-display text-5xl text-foreground">Page not found</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          The page you're looking for has wandered off into the jungle.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="heading-display text-3xl text-foreground">This page didn't load</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sungreen Habarana — Restaurant & Fine Dining" },
      { name: "description", content: "A nature-inspired luxury restaurant in Habarana serving authentic Sri Lankan cuisine with modern flair." },
      { property: "og:title", content: "Sungreen Habarana — Restaurant" },
      { property: "og:description", content: "Luxury jungle dining in the heart of Habarana, Sri Lanka." },
